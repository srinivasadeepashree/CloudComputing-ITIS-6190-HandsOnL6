...
# Load datasets
listeninglogs = spark.read.csv("/workspaces/CloudComputing-ITIS-6190-HandsOnL6/listening_logs.csv", header=True, inferSchema=True)
songsmetadata = spark.read.csv("/workspaces/CloudComputing-ITIS-6190-HandsOnL6/songs_metadata.csv", header=True, inferSchema=True)
